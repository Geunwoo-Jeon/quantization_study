...
- **기존 지식**: CNN 양자화(Image Compression Network 양자화 논문), DL 기초(convolution, backpropagation 등), Transformer block 구조, Activation Quantization의 어려움(outlier 문제 등), MoE 기본 개념
...
| 16 | RoPE | |
| 17 | SwiGLU / GeGLU | |
| 18 | Weight Packing / Bit Packing | |
| 19 | DMA와 Double Buffering | |
| 20 | RMSNorm vs LayerNorm | |
...
이미 감이 있는 주제들. 이 Phase를 마치면 **현재 LLM 양자화의 전체 지형도**가 그려진다.

| # | 주제 | 사전 지식 상태 | 핵심 논문 | 핵심 아이디어 |
|---|------|-------------|----------|-------------|
